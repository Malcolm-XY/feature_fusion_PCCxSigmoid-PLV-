...
def normal_evaluation_framework():
    ...
    for nrr in nrr_list:
        ...
        # cnn_subnetworks_evaluation_circle_original_cm(feature_cm='pcc', # 'plv', 'pli'
        ...
        #                                                  params={'fusion_type': 'additive', # multiplicative, triangle_blocking, diagonal_blocking
        #                                                          'normalization_basis': True, 'normalization_modifier': False,
        #                                                          'scale': (0, 1)},
        #                                                  normalization_for_train=False,
        #                                                  subject_range=range(6,16), experiment_range=range(1,4),
        ...
        # %% Proposed Methods: PCCxSigmoid(PLV)
        # heaviside gating
        ...
        # cnn_subnetworks_evaluation_circle_feature_fusion_pcaec(feature_basis='pcc', feature_modifier='pli',
        ...
        # %% PLIxSigmoid(PCC)
        # # heaviside gating
        # params_a={'fusion_type': 'heaviside_gating',
        #           'percentile': 25,
        #           'normalization_basis': False,
        #           'normalization_modifier': True}
        # params_b, params_g = params_a.copy(), params_a.copy()
