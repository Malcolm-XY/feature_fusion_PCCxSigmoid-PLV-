...
def normal_evaluation_framework():
    ...
    for nrr in nrr_list:
        ...
        # %% PCCxSigmoid(PLV); PLVxSigmoid(PLV)
        # heaviside gating
        ...
        # %% PLVxSigmoid(PCC); PCCxSigmoid(PCC)
        # heaviside gating
        params_a={'fussion_type': 'heaviside_gating', 
                  'percentile': 60.81,
                  'normalization': True}
